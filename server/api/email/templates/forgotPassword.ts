...
const createEmailTemplate = function (
  accountName: string,
  urlRedirect: string
): EmailTemplate {
  const html = `
                      ...
                      <tr>
                        <td class="sm-px-24"
                          ...
                          <p style="margin: 0 0 24px;">
                            ...
                            Você será redirecionado para a página de redefinição de senha da nossa plataforma
                          </p>

                          <lable style="display: block; font-size: 24px; line-height: 100%; margin-bottom: 24px; --text-opacity: 1; color: #000000; text-decoration: none;">${'NossaComuna'}</lable>
                          ...
                          <p style="margin: 0 0 16px;">
                            <a href="${urlRedirect}" class="hover-underline" style="--text-opacity: 1; color: #7367f0;  text-decoration: none;">Redefinir minha senha</a>.
                          </p>
                        </td>
                      </tr>
                      <tr>
